"""Runs a ResNet model on the NTURGB+D dataset."""
#"""cross view protocol"""
...
parser.add_argument('--model_dir', type=str, default='/home/qnie/PycharmProjects/ntumotion/model_CV_fEDM_R/',
...
def get_filenames(is_training, datadir):
  ...
  if(is_training):
      labels = []
      data_dir = []
      with open('/home/qnie/PycharmProjects/ntumotion/training_protocol/fEDM_RS_CV_trainimgs.txt') as f:
          for line in f:
              data_dir.append(datadir + line.strip())
              # data_dir.append(datadir+'crossview_train/'+line.strip())
      f.close()

      with open('/home/qnie/PycharmProjects/ntumotion/training_protocol/fEDM_RS_CV_trainlabels.txt') as f:
          for line in f:
      ...
      labels = []
      data_dir = []
      with open('/home/qnie/PycharmProjects/ntumotion/training_protocol/fEDM_RS_CV_testimgs.txt') as f:
          for line in f:
              data_dir.append(datadir + line.strip())
              # data_dir.append(datadir + 'crossview_test/' + line.strip())
      f.close()

      with open('/home/qnie/PycharmProjects/ntumotion/training_protocol/fEDM_RS_CV_testlabels.txt') as f:
          for line in f:
              labels.append(int(line.strip()))
      f.close()
...
def _parse_function(filename, label):
  ...
  #  pad the image into a size of (128,128,1)
  # image_padded = tf.pad(image, [[4, 4], [0, 0], [0, 0]])
...
def motionrcg_model_fn(features, labels, mode, params):
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
        ...
        values = [initial_learning_rate * decay for decay in [1, 0.1, 0.05, 0.01, 1e-3]]
...
def main(unused_argv):
    ...
    #         input_fn=lambda: input_fn(False, FLAGS.datadir, FLAGS.batch_size),
    #         checkpoint_path= './model_CV_final/bests/model.ckpt-54136'))
    ...
    # with open("./model_CV_final/bests/train_predsJson54136.json", "w") as f:
